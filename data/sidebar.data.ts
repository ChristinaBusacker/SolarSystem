...
export const astronomicalMoonSidebarContent: Record<string, BodyInfoOverride> = {
    ...
    deimos: {
        ...
        atmosphere:
            "Deimos has no substantial atmosphere and cannot retain gases around its surface.",
        facts: [
    ...
    mimas: {
        ...
        atmosphere:
            "Mimas has no substantial atmosphere and cannot retain gases at its surface.",
        facts: [
    ...
    tethys: {
        ...
        atmosphere:
            "Tethys has no substantial atmosphere and no stable surface pressure.",
        facts: [
    ...
    iapetus: {
        ...
        atmosphere:
            "Iapetus has no substantial atmosphere and does not retain gases near its surface.",
        facts: [
    ...
    miranda: {
        ...
        surfaceTemperature:
            "Surface temperatures are extremely low, typically near -187°C on average.",
        atmosphere:
            "Miranda has no substantial atmosphere and no stable surface pressure.",
        facts: [
    ...
    proteus: {
        ...
        surfaceTemperature:
            "Surface temperatures are extremely low, typically near -220°C or colder.",
        atmosphere:
            "Proteus has no substantial atmosphere and cannot retain gases near the surface.",
        facts: [
    ...
    nereid: {
        ...
        atmosphere:
            "Nereid has no substantial atmosphere and no stable surface pressure.",
        facts: [
