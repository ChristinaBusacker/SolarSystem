export const earthShader = {
  vertexShader: `
    uniform vec3 sunPosition;  // Hinzufügen der Uniform-Deklaration
    varying vec2 vUv;
  ...
  `,
  fragmentShader: `
    uniform vec3 sunPosition;  // Die Uniform muss auch im Fragment-Shader deklariert werden, wenn sie hier verwendet wird
    varying vec2 vUv;
    varying vec3 vWorldNormal;
    varying vec3 vWorldPosition;
    varying vec3 vToSun;
